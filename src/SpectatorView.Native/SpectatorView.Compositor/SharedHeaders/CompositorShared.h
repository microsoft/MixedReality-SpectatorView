...
#define FRAME_BPP_DEPTH16 2
#define FRAME_BPP_BODY8 1
...
#define FRAME_BUFSIZE_DEPTH16       (FRAME_WIDTH * FRAME_HEIGHT * FRAME_BPP_DEPTH16)
#define FRAME_BUFSIZE_BODY8         (FRAME_WIDTH * FRAME_HEIGHT * FRAME_BPP_BODY8)
