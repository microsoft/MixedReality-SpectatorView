...
{
    public class SpatialAnchorsCoordinateService2 : SpatialCoordinateServiceUnityBase<string>
    {
        ...
        public SpatialAnchorsCoordinateService2(GameObject parent, SpatialAnchorsConfiguration spatialAnchorsConfiguration)
        {
            ...
            if (this.parent != null)
            {
                Debug.Log("SpatialAnchorsCoordinateService: Creating SpatialAnchorManager.");
                SpatialAnchorConfig config = SpatialAnchorConfig.Create(spatialAnchorsConfiguration.AccountId, spatialAnchorsConfiguration.AccountKey);
